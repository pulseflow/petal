/**
 * Utilities for asynchronously matching files of a specific type using Node.js and ES2018+ APIs.
 */
...
export type FileNamePredicate = (filePath: string) => boolean;
 ...
 * ```
 */
export async function* findFilesRecursively(path: PathLike, predicate: FileNamePredicate = () => true): AsyncIterableIterator<string> {
 ...
 */
export function findFilesRecursivelyStringStartsWith(path: PathLike, fileStartsWith: string): AsyncIterableIterator<string> {
 ...
 */
export function findFilesRecursivelyStringEndsWith(path: PathLike, fileEndsWith: string): AsyncIterableIterator<string> {
 ...
 */
export function findFilesRecursivelyStringIncludes(path: PathLike, include: string): AsyncIterableIterator<string> {
 ...
 */
export function findFilesRecursivelyRegex(path: PathLike, regex: RegExp): AsyncIterableIterator<string> {
