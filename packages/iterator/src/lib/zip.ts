 ...
 * @example
 * ```typescript
 * import { zip } from '@flowr/iterator';
 *
 ...
 * ```
 */
export function* zip<const Iterables extends ReadonlyArray<IterableResolvable<any>>>(...iterables: Iterables): ZipIterators<Iterables> {
...
export type ZipIterators<Iterators extends ReadonlyArray<IterableResolvable<any>>> = IterableIterator<{
