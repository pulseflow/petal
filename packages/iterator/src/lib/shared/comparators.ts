import type { CompareByComparator, LexicographicComparison } from './_compare.ts';
 ...
 * @seealso 23.1.3.30.2 CompareArrayElements ({@linkplain https://tc39.es/ecma262/#sec-comparearrayelements})
 *
