...
export const orderingIsLess = (ordering: number): boolean => ordering < 0;
export const orderingIsEqual = (ordering: number): boolean => ordering === 0;
export const orderingIsGreater = (ordering: number): boolean => ordering > 0;
