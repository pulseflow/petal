...
export class RateLimitManager<ID = string> extends Map<ID, RateLimit<ID>> {
	/**
	 ...
	 */
	public sweepInterval!: NodeJS.Timeout | undefined | null;
	 ...
	 */
	public acquire(id: ID): RateLimit<ID> {
		return this.get(id) ?? this.create(id);
	}

	/**
	 * Creates a {@link RateLimit} for this manager.
	 * @param id The {@link ID} the {@link RateLimit} belongs to
	 */
	public create(id: ID): RateLimit<ID> {
	 ...
	 */
	public override set(id: ID, value: RateLimit<ID>): this {
