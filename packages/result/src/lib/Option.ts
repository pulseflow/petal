...
export class Option<T, Exists extends boolean = boolean> {
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/option/enum.Option.html#method.is_some}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/option/enum.Option.html#method.is_some_and}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/option/enum.Option.html#method.is_none}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/option/enum.Option.html#method.expect}
	 */
	 ...
	 * Returns the contained `Some` value.
	 *
	 * If the value is an {@link Err `Err`}, it throws an {@link OptionError} with the message.
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/option/enum.Option.html#method.unwrap}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/option/enum.Option.html#method.map_or}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/option/enum.Option.html#method.inspect}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/option/enum.Option.html#method.xor}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/option/enum.Option.html#method.filter}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/option/enum.Option.html#method.contains}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/option/enum.Option.html#method.zip}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/option/enum.Option.html#method.zip_with}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/option/enum.Option.html#method.unzip}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/option/enum.Option.html#method.transpose}
	 */
