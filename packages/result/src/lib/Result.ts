 ...
 *
 * @see {@linkplain https://doc.rust-lang.org/std/result/index.html}
 */
export class Result<T, E, const Success extends boolean = boolean> {
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.is_ok}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.is_ok_and}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.is_err}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.is_err_and}
	 */
	...
	/**
	 * Maps a `Result<T, E>` to `Result<U, E>` by applying a function to a contained {@link Ok `Ok`} value, leaving an {@link Err `Err`} value
	 * untouched.
	 * @param cb The predicate.
	 *
	 * @example
	...
	/**
	 * Maps a `Result<T, E>` to `Result<T, F>` by applying a function to a contained {@link Ok `Ok`} value, leaving an {@link Err `Err`} value
	 * untouched.
	 *
	 * Unlike {@link map}, this method does not wrap the returned value inside {@link Ok `Ok`}, but instead, it returns the
	 * returned value.
	 * @param cb The predicate.
	 *
	 * @example
	...
	/**
	 * Returns the provided default (if {@link Err `Err`}), or applies a function to the contained value (if {@link Ok `Ok`}),
	 *
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.map_or}
	 */
	...
	/**
	 * Maps a `Result<T, E>` to `U` by applying fallback function default to a contained {@link Err `Err`} value, or function `cb`
	 * to a contained {@link Ok `Ok`} value.
	 *
	 * This function can be used to unpack a successful result while handling an error.
	 * @param op The predicate that is run on {@link Err `Err`}.
	 * @param cb The predicate that is run on {@link Ok `Ok`}.
	 *
	 * @example
	 * ```typescript
	...
	/**
	 * Maps a `Result<T, E>` to `Result<T, F>` by applying a function to a contained {@link Err `Err`} value, leaving an {@link Ok `Ok`} value
	 * untouched.
	 *
	 ...
	 * This function can be used to pass through a successful result while handling an error.
	 *
	 * Unlike {@link mapErr}, this method does not wrap the returned value inside {@link Err `Err`}, but instead, it returns the
	 * returned value.
	 * @param cb The predicate.
	 *
	 * @example
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.inspect}
	 */
	public inspect(cb: (value: T) => unknown): this {
		if (this.isOk())
			cb(this[ValueProperty]);
		return this;
	}

	/**
	 * Calls the provided closure with a reference to the contained value (if {@link Ok `Ok`}) and awaits it.
	 * @param cb The predicate.
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.inspect_err}
	 */
	...
	/**
	 * Calls the provided closure with a reference to the contained error (if {@link Err `Err`}) and awaits it.
	 * @param cb The predicate.
	...
	/**
	 * Returns the contained {@link Ok `Ok`} value.
	 *
	 * If the value is an {@link Err `Err`}, it throws a {@link ResultError} with the given message and the content of the {@link Err `Err`}.
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.expect}
	 */
	public expect(message: string): If<Success, T, never> {
		if (this.isErr())
			throw new ResultError(message, this[ValueProperty]);
		return this[ValueProperty] as If<Success, T, never>;
	}

	/**
	 * Returns the contained {@link Err `Err`} value.
	 *
	 * If the value is an {@link Ok `Ok`}, it throws a {@link ResultError} with the given message and the content of the {@link Ok `Ok`}.
	 * @param message The message for the error.
	 *
	 * @example
	 * ```typescript
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.expect_err}
	 */
	 ...
	 * Returns the contained {@link Ok `Ok`} value.
	 *
	 * If the value is an {@link Err `Err`}, it throws a {@link ResultError} with the message, and the content of the {@link Err `Err`}.
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.unwrap}
	 */
	public unwrap(): If<Success, T, never> {
		if (this.isErr())
			throw new ResultError('Unwrap failed', this[ValueProperty]);
		return this[ValueProperty] as If<Success, T, never>;
	}
	 ...
	 * Returns the contained {@link Err `Err`} value.
	 *
	 * If the value is an {@link Ok `Ok`}, it throws a {@link ResultError} with the message, and the content of the {@link Ok `Ok`}.
	 * @seealso {@link unwrap}
	 * @seealso {@link unwrapOr}
	 * @seealso {@link unwrapOrElse}
	 * @seealso {@link unwrapRaw}
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.unwrap_err}
	 */
	...
	/**
	 * Returns the contained {@link Ok `Ok`} value or the provided default.
	 *
	 ...
	 * Returns the contained {@link Ok `Ok`} value.
	 *
	 * If the value is an {@link Err `Err`}, it throws the contained error.
	 * @seealso {@link unwrap}
	 * @seealso {@link unwrapOr}
	 * @seealso {@link unwrapOrElse}
	 * @seealso {@link unwrapErr}
	...
	public unwrapRaw(): If<Success, T, never> {
		if (this.isErr())
			throw this[ValueProperty];
		// @ts-expect-error: Complex types
		return this[ValueProperty] as T;
	}

	/**
	 * Returns `result` if the result is {@link Ok `Ok`}, otherwise returns the {@link Err `Err`} value of itself.
	...
	/**
	 * Return `result` if the result is {@link Err `Err`}, otherwise returns the {@link Ok `Ok`} value of self.
	 *
	...
	/**
	 * Calls `cb` if the result is {@link Err `Err`}, otherwise returns the {@link Ok `Ok`} value of self.
	 *
	...
	/**
	 * Returns `true` if the result is an {@link Ok `Ok`} and the given value strict equals it.
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.contains}
	 */
	...
	/**
	 * Returns `true` if the result is an {@link Err `Err`} and the given error strict equals it.
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.contains_err}
	 */
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.transpose}
	 */
	...
	/**
	 * Returns the {@link Ok `Ok`} value if self is {@link Ok `Ok`}, and the {@link Err `Err`} value if self is {@link Err `Err`}.
	 *
	 * @example
	 * ```typescript
	 ...
	 * ```
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/result/enum.Result.html#method.into_ok_or_err}
	 */
	...
	/**
	 * Returns a `Promise` object with the awaited value (if {@link Ok `Ok`}) or the awaited error (if {@link Err `Err`}).
	 *
	 * @example
	 * ```typescript
	 ...
	 *
	 * @see {@linkplain https://doc.rust-lang.org/std/cmp/trait.PartialEq.html#tymethod.eq}
	 */
	 ...
	 */
	public static all<const Entries extends readonly AnyResult[]>(this: void, results: Entries): Result<UnwrapOkArray<Entries>, UnwrapErrArray<Entries>[number]> {
	 ...
	 * @returns A new {@link Result}.
	 */
	public static any<const Entries extends readonly AnyResult[]>(this: void, results: Entries): Result<UnwrapOk<Entries[number]>, UnwrapErrArray<Entries>> {
