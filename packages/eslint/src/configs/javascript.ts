import type { OptionsJavaScript, TypedFlatConfigItem } from '../types/index.ts';
		...
		},
		{
			...
			rules: {
				...
				'no-restricted-syntax': [
					'error',
					{ message: 'Use `enum` instead.', selector: 'TSEnumDeclaration[const=true]' },
					{ message: 'Use `export default` instead.', selector: 'TSExportAssignment' },
				],
