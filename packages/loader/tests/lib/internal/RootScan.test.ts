 ...
 */
const testsFixturesJoin = (...path: string[]) => join('tests', 'fixtures', ...path);
...
describe('rootScan', () => {
	describe('commonjs', () => {
		...
		it('given commonjs && main property then returns correct root', () => {
	...
	describe('module', () => {
		...
		it('given esmodule && main property then returns correct root', () => {
		...
		it('given esmodule && module property then returns correct root', () => {
	...
	describe('undefined', () => {
		...
		it('given undefined && main property then returns correct root', () => {
		...
		it('given undefined && module property then returns correct root', () => {
