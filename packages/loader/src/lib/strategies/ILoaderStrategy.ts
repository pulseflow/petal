/* eslint-disable ts/method-signature-style -- interface */
import type { Awaitable, Constructor, Ctor } from '@flowr/types';
 ...
 * @private
 */
export const hydrateModuleData = (root: string, data: ModuleData): HydratedModuleData => ({ root, ...data });
